...
/**
 * Strings for component 'quiz_scoreboard', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['privacy:metadata'] = 'The Quiz Scoreboard plugin does not store any personal data. It provides an interface for teachers to view data from quizzes without storing any data itself.';
